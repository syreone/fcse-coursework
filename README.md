...
Цикломатската комплексност ја добив преку борење на регионите како што се обележани на цртежот.

V(G) = 5 за функцијата searchBookByTitle

V(G) = 5 за функцијата borrowBook
