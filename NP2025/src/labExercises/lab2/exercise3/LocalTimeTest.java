package labExercises.lab2.exercise3;
...
public class LocalTimeTest {
    ...
    static LocalTime localTimeOfHourToNanoSec() {
         ...
         */
        return LocalTime.of(23, 7, 3, 100_000_000); // 0.1 seconds = 100,000,000 nanoseconds
    }
    ...
    static LocalTime localTimeMinusDuration() {
         ...
         */
        Duration duration = Duration.ofHours(3).plusMinutes(30).plusMillis(20200); // 20.2 sec = 20200 ms
